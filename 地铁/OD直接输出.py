...
for mm in range(4,5):		
	for dd in range(24,25):	
		...
		for xmz in ['2688','3680','3690']:
			with open(r'E:\广州公交\广州项目\地铁\CX'+xmz+'0012018'+str(mm)+str(dd)+'08\JY'+xmz+'0012018'+str(mm)+str(dd)+'08.txt','r+', encoding='gbk') as f:
				print('luruwancheng')
		...
		with open('E:\广州公交\yjt\CX\\'+str(mm)+str(dd)+'\\tongji_'+str(mm)+str(dd)+'_CX.txt','w') as f:
			...
			f.write(str(cz_n))
			f.write('\n')
			f.write('早高峰%s人，晚高峰%s人'%(zgf_num, wgf_num))
